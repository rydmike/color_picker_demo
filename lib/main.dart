...
class _ColorPickerPageState extends State<ColorPickerPage> {
  ...
  static const Color _blueBlues = Color(0xFF174378);
  ...
  final Map<ColorSwatch<Object>, String> _customColorNameMap =
    ...
    ColorTools.createPrimaryColor(_blueBlues): 'Blue blues',
    ColorTools.createPrimaryColor(_customColor1): 'Clear blue',
    ColorTools.createPrimaryColor(_customColor2): 'Dark pink',
    ColorTools.createPrimaryColor(_customColor3): 'Red wine',
    ColorTools.createPrimaryColor(_customColor4): 'Grass green',
    ColorTools.createPrimaryColor(_customColor5): 'Money green',
    ColorTools.createPrimaryColor(_customColor6): 'Mandarin orange',
    ColorTools.createPrimaryColor(_customColor7): 'Bright orange',
    ColorTools.createPrimaryColor(_customColor8): 'Bright green',
    ColorTools.createPrimaryColor(_customColor9): 'Washed jean blue',
    ColorTools.createPrimaryColor(_customColor10): 'Deep blue sea',
  };
